...
ModeS = "https://img2.pngio.com/red-x-background-png-download-38402160-free-transparent-2017-tesla-model-s-png-900_520.jpg"
...
class AnimValue extends React.Component {
    ...
    animate(previousValue, newValue, applyFn) {
        ...
        const renderFunction = (step) => { this.timeout = setTimeout(() => { applyFn(this.props.transformFn(previousValue + diff * step, step), step); }, this.props.delay); };
